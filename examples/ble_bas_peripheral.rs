//! ble_bas_peripheral demo from the nrf_softdevice repo advertising a battery
//! device.
//!
//! Embassy requires nightly.
//! cargo run --release --example ble_bas_peripheral
//!
//! Pinout
//! BUTTON1 = SW1 = P1.6
//! RESET = SW2 = P0.18
...
use nrf52840_mdk::nrf_softdevice;
...
#[task]
async fn bluetooth_task(sd: &'static Softdevice, _config: peripheral::Config) {
...
fn main() -> ! {
    ...
    let (sdp, _p) = nrf52840_mdk::take_peripherals();
